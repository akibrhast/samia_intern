...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : STTS22H_INT_Pin LIS2MDL_DRDY_Pin */
  GPIO_InitStruct.Pin = STTS22H_INT_Pin | LIS2MDL_DRDY_Pin;
  ...
  /*Configure GPIO pins : LPS22DF_INT_Pin LSM6DSV16X_INT1_Pin LSM6DSV16X_INT2_Pin */
  GPIO_InitStruct.Pin = LPS22DF_INT_Pin | LSM6DSV16X_INT1_Pin | LSM6DSV16X_INT2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : LSM6DSO16IS_INT2_Pin */
...
void MX_GPIO_PE14_Init(void)
{
  ...
  /* EXTI interrupt init*/
  HAL_NVIC_SetPriority(LSM6DSV16X_INT2_EXTI_IRQn, 7, 0);
...
void MX_GPIO_PC3_Init(void)
{
  ...
  /* EXTI interrupt init*/
  HAL_NVIC_SetPriority(LIS2MDL_DRDY_EXTI_IRQn, 7, 0);
...
void MX_GPIO_PB1_Init(void)
{
  ...
  /* EXTI interrupt init*/
  HAL_NVIC_SetPriority(LIS2DUXS12_INT_EXTI_IRQn, 7, 0);
...
void MX_GPIO_PG12_Init(void)
{
  ...
  /* EXTI interrupt init*/
  HAL_NVIC_SetPriority(LSM6DSO16IS_INT2_EXTI_IRQn, 7, 0);
...
void MX_GPIO_PE9_Init(void)
{
  ...
  /* EXTI interrupt init*/
  HAL_NVIC_SetPriority(LPS22DF_INT_EXTI_IRQn, 7, 0);
  HAL_NVIC_EnableIRQ(LPS22DF_INT_EXTI_IRQn);
}
...
void MX_GPIO_PC2_Init(void)
{
  ...
  /* EXTI interrupt init*/
  HAL_NVIC_SetPriority(STTS22H_INT_EXTI_IRQn, 7, 0);
  HAL_NVIC_EnableIRQ(STTS22H_INT_EXTI_IRQn);
}
