...
/**
  ...
  */
typedef struct _MX_I3CParams_t
{
  I3C_HandleTypeDef *p_i3c_handle; /*!< HAL I3C handle */
  IRQn_Type i3c_ev_irq_n; /*!< I3C EV interrupt number. */
  IRQn_Type i3c_er_irq_n; /*!< I3C ER interrupt number. */
  IRQn_Type i3c_dma_tc_irq_n; /*!< DMA channel tc interrupt number. */
  IRQn_Type i3c_dma_rx_irq_n; /*!< DMA channel rx interrupt number. */
  IRQn_Type i3c_dma_tx_irq_n; /*!< DMA channel tx interrupt number. */
  void (*p_mx_init_f)(void); /*!< MX I3C initialization function */
...
/**
  ...
  */
extern const MX_GPIOParams_t MX_GPIO_LEDYellowInitParams;

/**
  * LIS2DUXS12_INT1 GPIO configuration parameters.
  */
...
/**
  * LSM6DSO16IS_INT1 GPIO configuration parameters.
  */
extern const MX_GPIOParams_t MX_GPIO_LSM6DSO16IS_INT1InitParams;
...
/**
  * STTS22H_INT GPIO configuration parameters.
  */
extern const MX_GPIOParams_t MX_GPIO_STTS22H_INTInitParams;
...
/**
  * I3C1 configuration parameters.
  */
extern const MX_I3CParams_t MX_I3C1InitParams;
