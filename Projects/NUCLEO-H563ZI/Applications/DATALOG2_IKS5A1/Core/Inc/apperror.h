...
#define SYS_BASE_I3C_M_ERROR_CODE                              SYS_BASE_SPI_M_ERROR_CODE + SYS_GROUP_ERROR_COUNT
...
#define SYS_BASE_I3CBUS_TASK_ERROR_CODE                       SYS_BASE_SPIBUS_TASK_ERROR_CODE + SYS_GROUP_ERROR_COUNT

// Utility task error code
#define SYS_UTIL_TASK_BASE_ERROR_CODE                         SYS_BASE_I3CBUS_TASK_ERROR_CODE + SYS_GROUP_ERROR_COUNT
