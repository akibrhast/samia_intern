/**
  ...
  ******************************************************************************
  */
#ifndef I3CBUSTASK_H_
#define I3CBUSTASK_H_
...
#endif
#ifndef SYS_BASE_I3CBUS_TASK_ERROR_CODE
#define SYS_BASE_I3CBUS_TASK_ERROR_CODE                     1
#endif
#define SYS_I3CBUS_TASK_IO_ERROR_CODE                       SYS_BASE_I3CBUS_TASK_ERROR_CODE + 1
#define SYS_I3CBUS_TASK_RESUME_ERROR_CODE                   SYS_BASE_I3CBUS_TASK_ERROR_CODE + 2
#define SYS_I3CBUS_TASK_UNSUPPORTED_CMD_ERROR_CODE          SYS_BASE_I3CBUS_TASK_ERROR_CODE + 3


/**
  * Create  type name for _I3CBusTask.
  */
typedef struct _I3CBusTask I3CBusTask;

/**
  *  I3CBusTask internal structure.
  */
struct _I3CBusTask
{
  /**
  ...
  /**
    ...
    * de-initialize the I3C IP in some of the PM state.
    */
...
/**
  * Allocate an instance of I3CBusTask.
  *
  * @param p_mx_drv_cfg [IN] specifies a ::MX_I3CParams_t instance declared in the mx.h file.
