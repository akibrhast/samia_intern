...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : PC13 PC0 VBUS_SENSE_Pin PC6
                           PC8 PC9 PC10 PC11
                           PC12 */
  GPIO_InitStruct.Pin = GPIO_PIN_13 | GPIO_PIN_0 | VBUS_SENSE_Pin | GPIO_PIN_6
  ...
  /*Configure GPIO pins : INT2_DLPC_Pin DRDY_MDC_Pin */
